...
class AccumuloDataStoreDeleteGeometriesTest extends Specification with TestWithDataStore {

  sequential

  val spec = "name:String,dtg:Date,*geom:Geometry:srid=4326"
  ...
  "AccumuloDataStore" should {
    "support deleting schemas" in {
      ...
      def buildPreSecondaryIndexTable(params: Map[String, String], sftName: String) = {
        ...
        metadataMutation.put("attributes", "", spec)
      ...
      def createFeature(sftName: String, ds: AccumuloDataStore, sharedTables: Boolean = true) = {
        ...
        builder.addAll(List("1", "2012-01-02T05:06:07.000Z", WKTUtils.read("POINT(45.0 45.0)")))
      ...
      "delete schema (without a z3 table) on a shared table" in {
